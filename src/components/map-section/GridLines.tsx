...
const GridLines = () => {
  return (
    <article className="c-home_grid-lines || grid col-1 row-1 relative z-10 w-full h-full pointer-events-none opacity-(--scroll-gridlines-opacity) desktop-only overflow-hidden">
        ...
        {/* horizontal lines */}
         <div className="c-home_grid_h-lines || col-1 row-1 grid grid-cols-4 grid-rows-3 w-full h-full"><div className="c-home_grid_h-line || col-span-4 row-start-2 flex opacity-40"><span className="inline-block w-[calc(100%-40px)] translate-x-3 h-px bg-forest-green"></span></div><div className="c-home_grid_h-line || col-span-4 row-start-3 flex opacity-40"><span className="inline-block w-[calc(100%-40px)] translate-x-3 h-px bg-forest-green"></span></div></div>
