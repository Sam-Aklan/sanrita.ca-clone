...
const CompassIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
   <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" className="m-0 fill-terrain-grey translate-y-[3px]" style={{
    '--rotation': "-218.70873786407768deg",
