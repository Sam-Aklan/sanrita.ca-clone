...
const DropDownBar = () => {
  ...
  return (
    <div className='mobile:col-4 mobile:row-1 mobile:translate-x-[calc(250%-var(--scroll-aside))] c-trail-box | mobile:relative mobile:h-40 w-47.5 h-10 absolute top-0 right-0 m-3 z-20' >
        <div className='grid grid-rows-[auto_auto_350px] m-6 place-self-end overflow-hidden w-47.5  max-mobile:overflow-visible max-mobile:absolute max-mobile:top-0 max-mobile:m-0 max-mobile:[clip-path:polygon(0%_0%,calc(100%-15px)_0%,100%_15px,100%_100%,0%_100%)] pointer-events-none ' ref={DropDownRef}>
