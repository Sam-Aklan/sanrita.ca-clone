...
const DropDownBar = () => {
  ...
  return (
    <div className='col-4 row-1 translate-x-[calc(100%-var(--scroll-aside))] c-trail-box | relative max-mobile:h-40 max-mobile:w-47.5' ref={DropDownRef}>
        <div className='grid grid-rows-[auto_auto_1fr] m-6 place-self-end overflow-hidden w-47.5  max-mobile:overflow-visible max-mobile:absolute max-mobile:top-0 max-mobile:m-0 max-mobile:[clip-path:polygon(0%_0%,calc(100%-15px)_0%,100%_15px,100%_100%,0%_100%)] pointer-events-auto '>
